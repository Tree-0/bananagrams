...
from backend.word_definitions import lookup_definitions, normalize_word, parse_definition_response
...
class WordDefinitionTests(unittest.TestCase):
    ...
    def test_lookup_definitions_handles_not_found_response(self):
        ...
        with patch("backend.word_definitions.urlopen", side_effect=error):
